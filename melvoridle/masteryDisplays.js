...
class MasterySkillOptionsElement extends HTMLElement {
    constructor() {
        ...
        this.masteryImage = createElement('img', {
            ...
            attributes: [['src', assets.getURI("assets/media/main/mastery_pool.png" /* Assets.MasteryPoolIcon */)]],
        });
        this.spendMasteryButton.append(...templateLangStringWithNodes('MENU_TEXT_MASTERY_SPEND_XP', { masteryImage: this.masteryImage }, {}, false));
    }
    connectedCallback() {
        this.appendChild(this._content);

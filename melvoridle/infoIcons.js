...
class SkillXpIconElement extends InfoIconElement {
    ...
    setXP(skill, xp, baseXP) {
        ...
        this.skillImage.alt = templateLangString('SKILL_NAME_SKILL_XP_NO_QTY', { skillName: skill.name });
        xp = Math.floor(xp);
        baseXP = Math.floor(baseXP);
        this.xp.textContent = `${Math.floor(xp)}`;
...
class MasteryXpIconElement extends InfoIconElement {
    constructor() {
        ...
        this.container = getElementFromFragment(this._content, 'container', 'div');
        this.image = getElementFromFragment(this._content, 'image', 'img');
        this.image.alt = templateLangString('MENU_TEXT_TOOLTIP_MASTERY_XP', { value: '' });
        this.xp = getElementFromFragment(this._content, 'xp', 'small');
        this.tooltipElem = new XpIconTooltipElement();
    }
    setXP(xp, baseXP) {
...
class MasteryPoolIconElement extends InfoIconElement {
    constructor() {
        ...
        this.container = getElementFromFragment(this._content, 'container', 'div');
        this.image = getElementFromFragment(this._content, 'image', 'img');
        this.image.alt = templateLangString('MENU_TEXT_TOOLTIP_MASTERY_POOL_XP', { value: '' });
        this.xp = getElementFromFragment(this._content, 'xp', 'small');
...
class StealthIconTooltipElement extends HTMLElement {
    constructor() {
        ...
        successSpan.append(...templateLangStringWithNodes('MENU_TEXT_SUCCESS_RATE', { value: this.successRate }, {}, false));
        ...
        doublingSpan.append(...templateLangStringWithNodes('MENU_TEXT_TOOLTIP_INCREASED_DOUBLING', { value: this.increasedDoubling }, {}, false));
        ...
        uniqueChanceSpan.append(...templateLangStringWithNodes('MENU_TEXT_TOOLTIP_NPC_UNIQUE_CHANCE', { value: this.npcUniqueChance }, {}, false));
        this.sourceContainer = getElementFromFragment(this._content, 'source-container', 'div');
    }
    connectedCallback() {
        this.appendChild(this._content);
